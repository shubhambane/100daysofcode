# Day 16: FLutter Online lessons app

![App Preview](assets/gitImages/day16.png)

## Project Overview

Welcome to Day 16 of my #100DaysOfCode Challenge! 🚀 Today, I've brought to life an exciting Online lessons app. This project is inspired by a fantastic design from [Dribbble](https://dribbble.com). I want to extend my heartfelt thanks to the brilliant designer for the inspiration!
...
I'd like to give credit to the amazing design that inspired this project. You can check out the original Dribbble design [here](https://dribbble.com/shots/23022686-Hi-amigo-Online-lessons-app).
...
2. Navigate to the project folder: `cd flutter/day16_flutter_onlinelessonsapp`
